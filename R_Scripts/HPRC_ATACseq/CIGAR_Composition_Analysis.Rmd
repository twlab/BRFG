...
knitr::opts_knit$set(root.dir = "/Users/juanmacias/Library/CloudStorage/Box-Box/LawsonLab/JuanMacias/Postdoc/HPRC/ATACseq/AutomaticTesting/Latest/CigarCompositionAnalysis/")
# Set input file path
...
# Read input file
CigarFlagCompositionTable<-read.table(InputFile, header=FALSE, sep="\t", stringsAsFactors=FALSE)
colnames(CigarFlagCompositionTable)<-c("Count", "Chromosome", "Class", "Sample", "Replicate", "Genome")

# Filter out chrM
CigarFlagCompositionTable<-subset(CigarFlagCompositionTable, Chromosome!="chrM")

subset(CigarFlagCompositionTable, !(Chromosome %in% c("chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", "chr9", "chr10", "chr11", "chr12", "chr13", "chr14", "chr15", "chr16", "chr17", "chr18", "chr19", "chr20", "chr21", "chr22", "chrX", "chrY","chrM")) & Genome=="Paternal")
...
CigarFlagCompositionTable$Genome[grep(".maternal", CigarFlagCompositionTable$Genome)]<-"Maternal"
CigarFlagCompositionTable$Genome[grep(".paternal", CigarFlagCompositionTable$Genome)]<-"Paternal"
...
#subset(CigarFlagCompositionTable.wide, Sample=="HG00621" & Replicate=="A" & Genome=="hg38")
#sum(subset(CigarFlagCompositionTable.wide, Sample=="HG00621" & Replicate=="A" & Genome=="hg38")$Total)
