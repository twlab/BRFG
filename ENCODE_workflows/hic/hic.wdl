...
workflow hic {
    ...
    input {
        ...
        # Resource parameters
        Int align_num_cpus = 4
        Int align_ram_gb_in_situ = 24
        Int align_ram_gb_intact = 24
        ...
        Int dedup_ram_gb_in_situ = 36
        Int dedup_ram_gb_intact = 36
...
task align {
    ...
    command {
        ...
        echo "Starting align"
        mkdir reference
        tar -xvvf ${idx_tar} -C reference
        reference_index_path=$(find reference -name \*.fasta | head -1)
...
task create_hic {
    input {
        ...
        Int ram_gb = 48
        Int juicer_tools_heap_size_gb = 44
