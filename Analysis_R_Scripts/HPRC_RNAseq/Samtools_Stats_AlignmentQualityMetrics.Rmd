---
title: "RNA-seq Samtools stats alignment quality analysis"
author: "CIG @ MGI"
date: "`r Sys.Date()`"
...
LinearGenome_file_list <- dir("/Users/juanmacias/Library/CloudStorage/Box-Box/LawsonLab/JuanMacias/Postdoc/HPRC/RNAseq/AlignmentQuality_Analysis/LinearAlignment_SamtoolsStats/AlignmentQualityMetrics", full.names = TRUE)
...
colnames(LinearGenome_Sample_Information) <- c("Sample", "Replicate", "Assembly", "Annotations")
...
lapply(
  ...
  function(X) read_stats(LinearGenome_file_list[X], sample=LinearGenome_Sample_Information[X,]$Sample, replicate=LinearGenome_Sample_Information[X,]$Replicate, assembly=LinearGenome_Sample_Information[X,]$Assembly, annotations=LinearGenome_Sample_Information[X,]$Annotations)
...
# Read in list of all files in the directory with full path
Pangenome_file_list <- dir("/Users/juanmacias/Library/CloudStorage/Box-Box/LawsonLab/JuanMacias/Postdoc/HPRC/RNAseq/AlignmentQuality_Analysis/PangenomeAlignment_SamtoolsStats/AlignmentQualityMetrics", full.names = TRUE)
...
Pangenome_Sample_Information <- gsub(".gencode", "_gencode", Pangenome_Sample_Information)

# split the string by "_" to make columns: Sample, Replicate, Assembly, Annotations and turn into a data frame
Pangenome_Sample_Information <- as.data.frame(do.call(rbind, strsplit(Pangenome_Sample_Information, "_")))
colnames(Pangenome_Sample_Information) <- c("Sample", "Replicate", "Assembly", "Annotations")
...
lapply(
  ...
  function(X) read_stats(Pangenome_file_list[X], sample=Pangenome_Sample_Information[X,]$Sample, replicate=Pangenome_Sample_Information[X,]$Replicate, assembly=Pangenome_Sample_Information[X,]$Assembly, annotations=Pangenome_Sample_Information[X,]$Annotations)
...
```{r plot combined plot, include=TRUE, fig.width=12.5, fig.height=20}
ggsave2("AlignmentQualityMetrics.gencode.png", CombinedPlot, width=12.5, height=20, dpi=300)
CombinedPlot
```
